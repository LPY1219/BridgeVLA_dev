...
class Camera:
    def __init__(self, camera_type="all", timestamp_tolerance_ms=80):
        ...
        static_serial_number_1 = 37019563  # top相机
        static_serial_number_2 = 34438347 # 右边相机
        static_serial_number_3 = 30519310  # 左边相机

        if camera_type == "all":
            # 三个第三视角相机
            self.cams =  [
                ZedCam(serial_number=static_serial_number_1),
                ZedCam(serial_number=static_serial_number_2),
                ZedCam(serial_number=static_serial_number_3)
            ]
            self.camera_types = ["3rd_1", "3rd_2", "3rd_3"]

        elif camera_type == "3rd_1":
            self.cams = [ZedCam(serial_number=static_serial_number_1)]
            self.camera_types = ["3rd_1"]

        elif camera_type == "3rd_2":
            self.cams = [ZedCam(serial_number=static_serial_number_2)]
            self.camera_types = ["3rd_2"]

        elif camera_type == "3rd_3":
            self.cams = [ZedCam(serial_number=static_serial_number_3)]
