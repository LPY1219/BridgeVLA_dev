...
def get_cam_extrinsic(type):
    if type == "3rd_1":
        ...
        trans=np.array([0.00821830569279338, -0.33126246210941096, 0.3417491831324331])
        quat=np.array([ -0.708070839769097, 0.4002575582001426,-0.2837426508657752,0.5078579339264162]) # x y z w
    elif type == "3rd_2":
        ...
        trans=np.array([1.011100195308138, -0.05144922476602232, 0.37852187140420956])
        quat=np.array([ -0.64060847749437123, -0.6059517617277171,0.3623825470625827,0.2899582998112722]) # x y z w
    else:
