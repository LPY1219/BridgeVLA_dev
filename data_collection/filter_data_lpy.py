...
if __name__ == "__main__":
    ...
    # 批量处理示例 - 新格式（3个第三视角相机）
    batch_filter_data(
        source_dir="/media/casia/data4/lpy/3zed_data/raw_data/put_red_bull_in_pink_plate",  # 新格式：3个第三视角相机
        target_dir="/media/casia/data4/lpy/3zed_data/filter_data/put_red_bull_in_pink_plate",
        thres_xyz=0.01,
