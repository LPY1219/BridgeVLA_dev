...
# 输出目录
OUTPUT_DIR="${ROOT_PATH}/metaworld_results_25_1task"
...
run_task_on_gpu() {
    ...
    if xvfb-run -a python "${ROOT_PATH}/finetune/MetaWorld/eval_dm.py" "${PYTHON_ARGS[@]}" >> "$LOG_FILE" 2>&1; then
