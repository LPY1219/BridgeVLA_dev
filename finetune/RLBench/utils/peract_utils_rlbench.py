...
DATA_FOLDER="/share/project/lpy/BridgeVLA/data/RLBench/raw_data"
TRAIN_REPLAY_STORAGE_DIR = "/share/project/lpy/BridgeVLA/data/RLBench/replay_buffer" # path to save buffer
