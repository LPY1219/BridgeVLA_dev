...
class RVTBoxRenderer():
    ...
    def _get_cube_cameras(
        ...
        # }
        cam_dict = {
            "top": {"eye": [-0.785181, -0.498037, 0.368035], "at": [0, 0, 0], "up": [0.219546, 0.331834, 0.917435]},
            "front": {"eye": [0.88373, 0.057565, 0.464443], "at": [0, 0, 0], "up": [-0.465662, 0.009143, 0.884916]},
            "right": {"eye": [-0.740838, 0.592564, 0.316272], "at": [0, 0, 0], "up": [0.272401, -0.165349, 0.94787]},
            "down": {"eye": [0, 0, -1], "at": [0, 0, 0], "up": [0, 1, 0]},
            "back": {"eye": [-1, 0, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
            "left": {"eye": [0, -1, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
        }
