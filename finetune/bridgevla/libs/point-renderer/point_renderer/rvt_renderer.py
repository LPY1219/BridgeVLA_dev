...
class RVTBoxRenderer():
    ...
    def _get_cube_cameras(
        ...
        # cam_dict = {
        #     "top": {"eye": [0.196029, -0.01643, 0.98046], "at": [0, 0, 0], "up": [-0.980593, -0.006503, 0.195947]},
        #     "front": {"eye": [0.998223, 0.013667, 0.358002], "at": [0, 0, 0], "up": [-0.058131, 0.00925, 0.998266]},
        #     "right": {"eye": [-0.009512, 0.949688, 0.313053], "at": [0, 0, 0], "up": [0.003435, -0.313034, 0.949736]},
        #     "down": {"eye": [0, 0, -1], "at": [0, 0, 0], "up": [0, 1, 0]},
        #     "back": {"eye": [-1, 0, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
        #     "left": {"eye": [0, -1, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
        ...
        # cam_dict = {
        #     "top": {"eye": [-0.808368, -0.492059, 0.323141], "at": [0, 0, 0], "up": [0.278619, 0.163748, 0.946339]},
        #     "front": {"eye": [0.821481, 0.068153, 0.566149], "at": [0, 0, 0], "up": [-0.570222, 0.091089, 0.816425]},
        #     "right": {"eye": [0.068811, 0.950161, 0.30407], "at": [0, 0, 0], "up": [0.030204, -0.306637, 0.951347]},
        #     "down": {"eye": [0, 0, -1], "at": [0, 0, 0], "up": [0, 1, 0]},
        #     "back": {"eye": [-1, 0, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
        #     "left": {"eye": [0, -1, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
        # }
        cam_dict = {
            "top": {"eye": [-0.785181, -0.498037, 0.368035], "at": [0.2, 0, -0.4], "up": [0.219546, 0.331834, 0.917435]},
            "front": {"eye": [0.88373, 0.057565, 0.464443], "at": [0.2, 0, -0.4], "up": [-0.465662, 0.009143, 0.884916]},
            "right": {"eye": [-0.740838, 0.592564, 0.316272], "at": [0.2, 0, -0.4], "up": [0.272401, -0.165349, 0.94787]},
            "down": {"eye": [0, 0, -1], "at": [0, 0, 0], "up": [0, 1, 0]},
            "back": {"eye": [-1, 0, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
            "left": {"eye": [0, -1, 0], "at": [0, 0, 0], "up": [0, 0, 1]},
        }
    ...
    def __call__(self, pc, feat, fix_cam=False, dyn_cam_info=None):
        ...
        if self.with_depth:
            ...
            img_out = pc_images
        # For Debug - COMMENTED OUT TO AVOID CREATING debug_img FOLDER
        # import numpy as np
        # import cv2
        # import time
        # import os
