...
from bridgevla.mvt.mvt_single_3 import MVT as MVTSingle
...
class MVT(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        :param wpt_local: location of the local wpt in 3D, tensor of shape
            (bs,N,3) the first point are the target pose
