...
class WanVideoPipeline(BasePipeline):
    ...
    def from_pretrained(
        ...
        if tokenizer_config is None:
            ...
            elif wan_type =="5B_TI2V_RGB_HEATMAP" or wan_type=="5B_TI2V_RGB_HEATMAP_MV":
        ...
        # When wan_type ends with "_MV", we need to use WanModel_mv which has multi-view forward logic
        if wan_type and wan_type.endswith("_MV"):
