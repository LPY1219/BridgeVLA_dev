...
# 设置环境变量
os.environ["COPPELIASIM_ROOT"] = f"{ROOT_PATH}/finetune/CoppeliaSim_Edu_V4_1_0_Ubuntu20_04"
...
def main():
    """主函数"""
    # 配置
    LORA_CHECKPOINT = f"{ROOT_PATH}/logs/Wan/train/Wan2.2-TI2V-5B_heatmap_lora/epoch-55.safetensors"
    ...
    OUTPUT_DIR = f"{ROOT_PATH}/Wan/DiffSynth-Studio/examples/wanvideo/model_inference/heatmap_inference_results/55_now"
    ...
    # 单个测试示例
    print("\n=== Single Image Test ===")
    test_image_path = f"{DATA_ROOT}/trail_0/bgr_images/000000.png"
