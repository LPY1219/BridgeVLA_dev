...
ROT_GRIP_CHECKPOINT="${ROOT_PATH}/logs/Wan/train/mv_rot_grip_v2/1_16_5gpu_no_cache_3zed/20251126_104032/epoch-4.pth"
...
IMG_SIZE="384,384"                           # 图像尺寸（height,width）
...
python3 "${ROOT_PATH}/Wan/DiffSynth-Studio/examples/wanvideo/model_inference/heatmap_inference_TI2V_5B_fused_mv_rot_grip_vae_decode_feature.py" "${PYTHON_ARGS[@]}"
