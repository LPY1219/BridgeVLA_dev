...
# ==============================================
# Multi-View View-Concatenation Model Inference Script
# ==============================================
# This script runs inference using WanModel with view-concatenation mode,
# where different views are concatenated along the batch dimension instead
# of using token concatenation or multi-view attention modules.
...
# ==============================================
# MV View Model Configuration
# ==============================================

# Model type - View concatenation (batch dimension)
...
# Output directory
OUTPUT_DIR="${OUTPUT_BASE}/mv_view"
...
TRAIL_END=5    # Ending trail number (e.g., 5 for trail_5)

# GPU device
export CUDA_VISIBLE_DEVICES=0

echo "=============================================="
echo "Running MV View Model Inference"
echo "=============================================="
...
echo "python3 heatmap_inference_mv_view.py ${PYTHON_ARGS[*]}"
echo ""

python3 "${PROJECT_ROOT}/examples/wanvideo/model_inference/heatmap_inference_mv_view.py" "${PYTHON_ARGS[@]}"
