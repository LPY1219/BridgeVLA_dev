...
if [ "$USE_DUAL_HEAD" = "true" ]; then
    python3 "${ROOT_PATH}/Wan/DiffSynth-Studio/examples/wanvideo/model_inference/heatmap_inference_TI2V_5B_fused_mv_copy.py" --use_dual_head
else
    python3 "${ROOT_PATH}/Wan/DiffSynth-Studio/examples/wanvideo/model_inference/heatmap_inference_TI2V_5B_fused_mv_copy.py"
fi
