...
elif [ -d "/DATA/disk2/lpy/BridgeVLA_dev" ]; then
    ROOT_PATH_4="/DATA/disk2/lpy/BridgeVLA_dev"
...
LORA_CHECKPOINT="${ROOT_PATH}/logs/Wan/train/Wan2.2-TI2V-5B_heatmap_rgb_lora/from_a100_3/unfreeze_modulate_true_differentproj_true_keypoint_epoch-4999.safetensors"
# ROT_GRIP_CHECKPOINT="${ROOT_PATH}/logs/Wan/train/from_a100_4/1zed_gripper_rot_keypoint_1500.pth"
...
# 各机器的数据集路径配置
MACHINE1_DATA_ROOT="/DATA/disk1/lpy/Franka_data_3zed_2_keypoint/put_red_bull_in_pink_plate"
MACHINE2_DATA_ROOT="/data/Franka_data_3zed_2_keypoint/put_red_bull_in_pink_plate"
MACHINE3_DATA_ROOT="/DATA/disk0/lpy/data/Franka_data_3zed_2_keypoint/put_red_bull_in_pink_plate"
