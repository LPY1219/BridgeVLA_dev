...
MACHINE6_DATA_ROOT="/mnt/robot-rfm/user/lpy/data/Franka_data_3zed_5/cook_6,/mnt/robot-rfm/user/lpy/data/Franka_data_3zed_5/pour_filter_6trail,/mnt/robot-rfm/user/lpy/data/Franka_data_3zed_5/put_lion_8"
...
# 输出路径（带时间戳）
task="cook6_pourfilter6trail_putlion8_multitask"
...
# 检查数据目录（支持多个逗号分隔的路径）
IFS=',' read -ra DATA_PATHS <<< "$DATA_ROOT"
