...
TRAIL_START="10"          # 起始trail编号，如1表示从trail_1开始。留空表示不限制
TRAIL_END="50"            # 结束trail编号，如50表示到trail_50结束。留空表示不限制
...
OUTPUT_PATH="${OUTPUT_BASE}/Wan2.2-TI2V-5B_heatmap_rgb_lora/40_trajectory_push_T_5_3camera_${NAME}/${TIMESTAMP}"
