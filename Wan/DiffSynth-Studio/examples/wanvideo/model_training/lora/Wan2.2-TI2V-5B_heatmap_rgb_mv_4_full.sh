...
# 机器1的路径配置
MACHINE1_HEATMAP_DATA_ROOT="/DATA/disk1/lpy/Franka_data_3zed_5/cook_5"
...
# 机器3的路径配置
MACHINE3_HEATMAP_DATA_ROOT="/DATA/disk0/lpy/data/Franka_data_3zed_5/cook_5"  # TODO: 根据实际任务修改
...
# 机器4的路径配置
MACHINE4_HEATMAP_DATA_ROOT="/DATA/disk1/lpy_a100_4/data/Franka_data_3zed_5/cook_5"  # TODO: 根据实际任务修改
...
# 机器5的路径配置
MACHINE5_HEATMAP_DATA_ROOT="/DATA/disk1/lpy_a100_1/Franka_data_3zed_5/cook_5"
...
NAME="push_T_5_pretrain_${LOAD_PRETRAINED_CHECKPOINT}_history_${NUM_HISTORY_FRAMES}_new_projection_full_train"
OUTPUT_PATH="${OUTPUT_BASE}/Wan2.2-TI2V-5B_heatmap_rgb_lora/8_trajectory_puhs_T_5_3camera_${NAME}_rgb_loss_${RGB_LOSS_WEIGHT}/${TIMESTAMP}"
...
SWANLAB_PROJECT="Wan2.2-TI2V-5B_heatmap_rgb_lora_push_T_5"  # SwanLab项目名称
