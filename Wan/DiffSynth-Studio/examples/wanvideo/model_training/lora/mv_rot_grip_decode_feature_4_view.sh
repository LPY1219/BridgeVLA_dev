...
#    - Channel concat: (b, 3_views, 96_channels, t, h, w) where 96=48_rgb+48_heatmap
#    - View concat (THIS SCRIPT): (b, 6_views, 48_channels, t, h, w) where 6=3_rgb+3_heatmap
# 2. Direct latent input (not VAE decoder intermediate features)
#    - Uses raw VAE latents (48 channels)
#    - Internal temporal upsampling in the model
# 3. Calls mv_rot_grip_vae_decode_feature_3_view.py (not _3.py)
