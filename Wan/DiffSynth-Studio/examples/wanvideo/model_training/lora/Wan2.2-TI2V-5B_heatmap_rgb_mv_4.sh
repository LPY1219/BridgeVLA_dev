...
# WAN_TYPE="5B_TI2V_RGB_HEATMAP_MV"
# 热力图专用参数
SEQUENCE_LENGTH=48       # 未来帧序列长度 # 热力图序列加上原始图像的得到的总帧数，必须除以4余一
...
NAME="pour_rgb_only_pretrain_${LOAD_PRETRAINED_CHECKPOINT}_history_${NUM_HISTORY_FRAMES}_seq_${SEQUENCE_LENGTH}_new_projection"
