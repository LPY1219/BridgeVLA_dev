...
OUTPUT_PATH="${OUTPUT_BASE}/mv_rot_grip/${TIMESTAMP}"
...
SWANLAB_EXPERIMENT="seq_10_epoch20_accmulate_2_latent_noise_0_1"
...
echo "================================================================"
echo "Multi-View Rotation and Gripper Prediction Training"
echo "================================================================"
...
accelerate launch --num_processes=${NUM_GPUS} \
    ...
    examples/wanvideo/model_training/mv_rot_grip_vae_decode_feature.py \
    --data_root ${DATA_ROOT} \
