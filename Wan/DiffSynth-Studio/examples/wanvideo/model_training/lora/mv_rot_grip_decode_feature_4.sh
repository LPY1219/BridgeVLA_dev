...
MACHINE1_DATA_ROOT="/DATA/disk1/lpy/Franka_data_3zed_5/cook_5"
...
# 机器2的路径配置
MACHINE2_DATA_ROOT="/data/Franka_data_3zed_5/cook_5"
...
# 机器4的路径配置
MACHINE4_DATA_ROOT="/DATA/disk1/lpy_a100_4/data/Franka_data_3zed_5/cook_5"
...
# 机器5的路径配置
MACHINE5_DATA_ROOT="/DATA/disk1/lpy_a100_1/Franka_data_3zed_5/cook_5"
...
# 指定Wan模型类型
# 可选值:
#   - 5B_TI2V_RGB_HEATMAP_MV_ROT_GRIP: 标准多视角模式（NUM_HISTORY_FRAMES=1时使用）
#   - 5B_TI2V_RGB_HEATMAP_MV_ROT_GRIP_HISTORY: 多帧历史模式（NUM_HISTORY_FRAMES>1时使用）
...
NAME="cook_5_${LOCAL_FEATURE_SIZE}_seq_${SEQUENCE_LENGTH}_history_${NUM_HISTORY_FRAMES}_3zed_different_projection_${USE_DIFFERENT_PROJECTION}_new_projection_with_gripper_${USE_INITIAL_GRIPPER_STATE}"
