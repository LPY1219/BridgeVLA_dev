#!/bin/bash
# ================================================================
# Multi-View Rotation and Gripper Delta Prediction Training Script
# 基于VAE编码特征预测旋转和夹爪变化量（不需要初始状态作为输入）
# 使用Cross-Attention建模未来帧与第一帧的关系
...
OUTPUT_PATH="${OUTPUT_BASE}/mv_rot_grip_delta_${TRAIL_START}_${TRAIL_END}/${TIMESTAMP}"
...
SWANLAB_PROJECT="mv_rot_grip_delta"
SWANLAB_EXPERIMENT="seq_12_cross_attn_no_initial_state"
...
echo "================================================================"
echo "Multi-View Rotation and Gripper Delta Prediction Training"
echo "(No initial state input, using Cross-Attention)"
echo "================================================================"
...
accelerate launch --num_processes=${NUM_GPUS} \
    ...
    examples/wanvideo/model_training/mv_rot_grip_delta.py \
    --data_root ${DATA_ROOT} \
