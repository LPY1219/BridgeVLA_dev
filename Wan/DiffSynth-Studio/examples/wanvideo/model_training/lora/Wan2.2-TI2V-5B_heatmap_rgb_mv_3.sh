...
# 机器3的路径配置
MACHINE3_HEATMAP_DATA_ROOT="/DATA/disk0/lpy/data/Franka_data_3zed_5/push_T_5"  # TODO: 根据实际任务修改
...
# 机器4的路径配置
MACHINE4_HEATMAP_DATA_ROOT="/DATA/disk1/lpy_a100_4/data/Franka_data_3zed_5/push_T_5"  # TODO: 根据实际任务修改
...
NAME="push_T_5_pretrain_${LOAD_PRETRAINED_CHECKPOINT}_history_${NUM_HISTORY_FRAMES}_new_projection"
OUTPUT_PATH="${OUTPUT_BASE}/Wan2.2-TI2V-5B_heatmap_rgb_lora/10_trajectory_push_T_5_3camera_${NAME}_specific_augmentation/${TIMESTAMP}"

# 预训练checkpoint路径配置（各机器的路径）
# 机器1的预训练checkpoint路径
MACHINE1_PRETRAINED_CHECKPOINT="/DATA/disk1/lpy/BridgeVLA_dev/logs/Wan/train/pretrain_ckpt/pretrain__epoch.safetensors"
# 机器2的预训练checkpoint路径
