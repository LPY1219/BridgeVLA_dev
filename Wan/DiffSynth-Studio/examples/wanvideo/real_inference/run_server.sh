...
LORA_CHECKPOINT="${ROOT_PATH}/logs/Wan/train/Wan2.2-TI2V-5B_heatmap_rgb_lora_view/5_trajectory_pour_3camera_view_concat_False_history_1_seq_24_new_projection_rgb_loss_0.08/20260110_081456/epoch-99.safetensors"
ROT_GRIP_CHECKPOINT="${ROOT_PATH}/logs/Wan/train/mv_rot_grip_v2_view/from_a100_3/pour_filter_5trail_epoch_99.pth"
